    ...
    <div class="col-sm-12 col-md-12 col-md-offset-">
     ...
     <div class="panel b-primary bt-md">
        <div class="panel-content">
            <div class="row">
                <div class="col-xs-6">
                    <h4 class="text-success">Manage news</h4>
                </div>
                    ...
                    <table id="basic-table" class="data-table table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <!--  <td><img src="{{asset('news/'.$row->image)}}" style="width:50px"></td> -->
                                <td><img src="{{(!empty($row->image))? asset('news/'.$row->image):asset('news/no.png')}}" style="width:50px"></td>
                               ...
                               <a href="{{route('news.edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
