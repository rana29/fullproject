                                ...
                                <div class="panel-content">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right">
                                           <a class="btn btn-primary " href="{{route('slider.view')}}">Manage slider</a> 
                                        ...
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="{{route('slider.store')}}" enctype="multipart/form-data" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="subtitle" id="email2" placeholder="Name" value="{{old('brand')}}">
                                                    </div>
                                                </div>
